...
def collect_file_data(data_file, root_key):
    ...
    which is returned. The passed argument data_file is the path of the
    specific file that data is taken from. root_key is the basic key on
    the firebase in which the data is eventually sent, limited to only
